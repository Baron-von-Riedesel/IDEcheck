...
link /nologo release\ideckvdd.obj /OUT:release\ideckvdd.DLL /MAP:release\ideckvdd.map /SUBSYSTEM:CONSOLE /DEF:IDECKVDD.DEF /OPT:NOWIN98 /LIBPATH:\hx\Lib dkrnl32.lib duser32.lib ntvdm.lib
